<!-- MAIN -->
				...
				<div class="container-fluid">
						...
						<div class="col-md-6">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Biểu đồ đường</h3>
								</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Biểu đồ khu vực</h3>
								</div>
								<div class="panel-body">
						...
						<div class="col-md-6">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Nhiều biểu đồ</h3>
								</div>
								<div class="panel-body">
	...
	<script src="<?php echo $level.asset_path."vendor/chartist/js/chartist.min.js";?>"></script>
	<script>
	$(function() {
		var options;
