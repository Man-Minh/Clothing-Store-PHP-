<?php
	include $level.content_path.'index_DSHoaDonCanDuyet_data.php';
?>
	<!-- MAIN -->
		<div class="main">
			<!-- MAIN CONTENT -->
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h1 class="panel-title"><b>Đơn hàng chờ duyệt</b></h1>
								</div>
								<div class="panel-body">
									<table class="table">
										...
										<tbody>
										<?php foreach ($DS_TrangThaiHoaDon_rowsdata as $hoadon) { ?>
											<tr>
												...
												<td>  <a href= " <?php echo $level.content_path.'Update_DuyetHoaDon_process.php?mahd='.$hoadon['MaHD']; ?> " > <i class="fa fa-check"> </i>  </a> </td>
