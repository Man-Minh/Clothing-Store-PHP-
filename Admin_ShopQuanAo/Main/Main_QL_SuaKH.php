                ...
                <div class="panel panel-profile">		
                    <div class="clearfix">
                        ...
                        <form action=" <?php echo $level.content_path.'Update_KhachHang_process.php'; ?> " method="post" enctype ="multipart/form-data">
                                ...
                                <legend> <h3> Quản Lý Khách Hàng </h3> </legend>
                                    <table id="space-table">
                                        ...
                                        <tr>
											...
											<td>ID Khách hàng:</td>
                                            <td><input type="text" name="txtID" required placeholder="VD: 1, 2, 3,..."  value="<?php echo $_GET['makh'];?> " readonly> </td>
                                        </tr>
                            ...
                            <fieldset>                               
								<button class="btn btn-info" type="submit" name="submitThemKH"  > Cập nhật </button>										
                            </fieldset>
                           </form>
